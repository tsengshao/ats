...
file='../data/selected_date/'model'_selected_manual.txt'
...
* figure setting 
  ...
  '! mkdir -p ./fig/'model'/daily/'
  'gxprint ./fig/'model'/daily/ats_'date'.png x1100 y850'
...
*  'color -levs 1 3 5 7 10 15 20 -gxout grfill -kind (255,255,255,0)->grainbow'
  ...
  '! mkdir -p ./fig/'model'/'date
  'gxprint ./fig/'model'/'date'/ats_'tstr'.png x1100 y850'
