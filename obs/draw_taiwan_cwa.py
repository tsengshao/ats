...
if __name__=='__main__':
    ...
    plt.ylabel('mm/hr')
    plt.tight_layout()
    plt.savefig('./fig/pcp_series_shao_2005_2020_notc.png',dpi=250)
    plt.show()
    ...
    ucartopy.Plot_cwb_comp(rainfall_label='weak', stn_lon=stn_lon, stn_lat=stn_lat, precip_array=composite_shao, figtitle='ATS shao', figname='ats_shao_notc')
